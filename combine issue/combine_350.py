from ursina import *
# Cf. LINE 84: temp_entity = Entity(parent=entity, ignore=True)



def combine_350(entity, analyze=False, auto_destroy=True, ignore=[]):
    verts = list()
    tris = list()
    norms = list()
    uvs = list()
    ...
    print('combined relative to entity - 3.5.0 version')
